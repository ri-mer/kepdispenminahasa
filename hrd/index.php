  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="" class="logo">
        ...
        <span class="logo-mini"><b>KEP</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Aplikasi Kepegawaian</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href='?module=pegawai'><i class="fa fa-user-md"></i><span>Data Pegawai</span></a></li>
          <li><a href='?module=sk_krj'><i class="glyphicon glyphicon-briefcase"></i><span>Data SK Pegawai</span></a></li>
          <li><a href='?module=prestasi'><i class="glyphicon glyphicon-thumbs-up"></i><span>Data Prestasi Pegawai</span></a></li>
          <li><a href='?module=hukuman'><i class="glyphicon glyphicon-thumbs-down"></i><span>Data Hukuman Pegawai</span></a></li>
