      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			...
			<th><h4 style="color:#fff">Pimpinan</h4>
			</th>
          ...
          <ul class="sidebar-menu">
			...
			<ul class="treeview-menu">
				...
				<li><a href='?module=laporan&aksi=sk_kerja' ><i class="glyphicon glyphicon-briefcase"></i><span>Data SK Pegawai</span></a></li>
				<li><a href='?module=laporan&aksi=daftar_prestasi' ><i class="glyphicon glyphicon-thumbs-up"></i><span>Data Prestasi Pegawai</span></a></li>
        <li><a href='?module=laporan&aksi=daftar_hukuman' ><i class="glyphicon glyphicon-thumbs-down"></i><span>Data Hukuman Pegawai</span></a></li>
			</ul>
			</li>
